...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.resume:
        ...
        # print(subnet)
        subnet_cfg = model.module.get_active_subnet_settings()
        print(subnet_cfg)
        best_acc, is_best, best_epoch = validate(
            train_loader, val_loader, model, criterion, args, 0, logger, logger_curve, best_acc, best_epoch, cfg=subnet_cfg
        )
        
        exit()
        
        # ############### propro #############
        cfg_train = {'resolution': 32, 'width': [24, 24, 32, 40, 64, 120, 192, 224, 1984], 'depth': [1, 5, 5, 5, 4, 3, 2], 'kernel_size': [3, 5, 5, 3, 5, 5, 3], 'expand_ratio': [1, 5, 6, 4, 4, 6, 6], 'type': [['conv'], ['conv', 'conv', 'conv', 'conv', 'conv'], ['conv', 'conv', 'conv', 'conv', 'add'], ['conv', 'conv', 'conv', 'add', 'add'], ['conv', 'add', 'add', 'conv'], ['conv', 'conv', 'add'], ['conv', 'add']], 'Energy': 0.193, 'Latency': 2.471, 'FLOPs': 4.83, 'acc': 69.3}

        # ############# ratio ############
        # cfg_train = {'resolution': 32, 'width': [16, 16, 32, 40, 72, 120, 192, 224, 1984], 'depth': [2, 5, 3, 3, 6, 6, 1], 'kernel_size': [3, 5, 5, 3, 5, 3, 5], 'expand_ratio': [1, 5, 6, 5, 4, 6, 6], 'type': [['conv', 'conv'], ['conv', 'conv', 'conv', 'conv', 'conv'], ['conv', 'conv', 'conv'], ['conv', 'conv', 'conv'], ['add', 'add', 'add', 'add', 'add', 'conv'], ['add', 'add', 'add', 'add', 'add', 'add', 'add', 'add'], ['add']], 'Energy': 0.196, 'Latency': 2.267, 'FLOPs': 4.42, 'acc': 61.79}
        ...
        # cfg_train = {'resolution': 32, 'width': [24, 16, 32, 40, 64, 112, 192, 224, 1984], 'depth': [1, 4, 6, 5, 4, 5, 1], 'kernel_size': [3, 5, 5, 5, 5, 5, 5], 'expand_ratio': [1, 4, 6, 6, 6, 6, 6], 'type': [['conv'], ['conv', 'conv', 'conv', 'conv'], ['conv', 'conv', 'conv', 'conv', 'conv', 'conv'], ['conv', 'conv', 'conv', 'add', 'conv'], ['conv', 'add', 'conv', 'conv'], ['conv', 'add', 'add', 'add', 'add'], ['conv']], 'FLOPs': 4.657, 'acc': 74.98}

        # cfg_train = {'resolution': 32, 'width': [16, 16, 32, 40, 64, 112, 192, 224, 1984], 'depth': [1, 4, 3, 4, 4, 3, 1], 'kernel_size': [3, 5, 5, 5, 5, 5, 5], 'expand_ratio': [1, 4, 6, 6, 6, 6, 6], 'type': [['conv'], ['conv', 'conv', 'conv', 'conv'], ['conv', 'conv', 'conv'], ['conv', 'conv', 'conv', 'add'], ['conv', 'add', 'conv', 'conv'], ['conv', 'add', 'add'], ['conv']], 'Energy': 0.161, 'Latency': 1.96, 'FLOPs': 3.751, 'acc': 74.49}

        # ############# propro #################
        # cfg_train = {'resolution': 32, 'width': [24, 24, 32, 40, 64, 120, 192, 224, 1984], 'depth': [1, 5, 5, 5, 4, 3, 2], 'kernel_size': [3, 5, 5, 3, 5, 5, 3], 'expand_ratio': [1, 5, 6, 4, 4, 6, 6], 'type': [['conv'], ['conv', 'conv', 'conv', 'conv', 'conv'], ['conv', 'conv', 'conv', 'conv', 'add'], ['conv', 'conv', 'conv', 'add', 'add'], ['conv', 'add', 'add', 'conv'], ['conv', 'conv', 'add'], ['conv', 'add']], 'Energy': 0.193, 'Latency': 2.471, 'FLOPs': 4.83, 'acc': 69.3}

        # cfg_train = {'resolution': 32, 'width': [24, 16, 32, 40, 64, 120, 192, 224, 1984], 'depth': [1, 5, 5, 5, 5, 3, 1], 'kernel_size': [3, 5, 5, 3, 5, 3, 3], 'expand_ratio': [1, 5, 6, 4, 4, 6, 6], 'type': [['conv'], ['conv', 'conv', 'conv', 'conv', 'conv'], ['conv', 'conv', 'conv', 'conv', 'add'], ['conv', 'conv', 'conv', 'add', 'add'], ['conv', 'add', 'add', 'add', 'add'], ['conv', 'add', 'add'], ['conv']], 'Energy': 0.175, 'Latency': 2.012, 'FLOPs': 4.277, 'acc': 68.98}

        # cfg_train = {'resolution': 32, 'width': [24, 24, 32, 40, 64, 120, 192, 224, 1792], 'depth': [2, 5, 3, 4, 4, 3, 1], 'kernel_size': [3, 5, 5, 3, 5, 5, 3], 'expand_ratio': [1, 5, 6, 6, 4, 6, 6], 'type': [['conv', 'add'], ['conv', 'conv', 'conv', 'conv', 'add'], ['conv', 'conv', 'conv'], ['conv', 'conv', 'conv', 'add'], ['conv', 'add', 'add', 'conv'], ['conv', 'add', 'conv'], ['conv']], 'Energy': 0.164, 'Latency': 1.81, 'FLOPs': 4.331, 'acc': 68.33}

        # ############### ratio ###################
        # cfg_train = {'resolution': 32, 'width': [16, 16, 32, 40, 72, 120, 208, 216, 1984], 'depth': [1, 5, 3, 5, 3, 3, 1], 'kernel_size': [3, 5, 5, 5, 5, 5, 3], 'expand_ratio': [1, 6, 6, 6, 4, 6, 6], 'type': [['conv', 'conv'], ['conv', 'conv', 'conv', 'conv', 'conv'], ['conv', 'conv', 'conv'], ['conv', 'conv', 'add', 'add', 'conv'], ['add', 'add', 'add'], ['add', 'conv', 'add'], ['add']], 'Energy': 0.162, 'Latency': 2.056, 'FLOPs': 4.302, 'acc': 62.81}

        # ################ no_constraint ######################
        cfg_train = {'resolution': 32, 'width': [16, 16, 32, 40, 64, 128, 200, 216, 1792], 'depth': [1, 5, 3, 3, 6, 3, 2], 'kernel_size': [3, 3, 5, 3, 3, 3, 3], 'expand_ratio': [1, 4, 6, 5, 5, 6, 6], 'type': [['add'], ['conv', 'conv', 'conv', 'conv', 'conv'], ['conv', 'conv', 'conv'], ['conv', 'add', 'conv'], ['conv', 'conv', 'add', 'conv', 'conv', 'conv'], ['conv', 'add', 'conv'], ['conv', 'conv']], 'FLOPs': 6.408639446492785, 'acc': 51.45}
